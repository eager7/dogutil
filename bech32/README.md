...
```bash
$ go get -u github.com/eager7/dogutil/bech32
```

## Examples

* [Bech32 decode Example](http://godoc.org/github.com/eager7/dogutil/bech32#example-Bech32Decode)
  Demonstrates how to decode a bech32 encoded string.
* [Bech32 encode Example](http://godoc.org/github.com/eager7/dogutil/bech32#example-BechEncode)
