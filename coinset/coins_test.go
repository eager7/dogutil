...
func NewCoin(index int64, value dogutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = dogutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = dogutil.NewTxFromBytes(testSimpleCoinTxBytes)
