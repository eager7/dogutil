...
func (k *ExtendedKey) Child(i uint32) (*ExtendedKey, error) {
	...
	parentFP := dogutil.Hash160(k.pubKeyBytes())[:4]
...
func (k *ExtendedKey) Address(net *chaincfg.Params) (*dogutil.AddressPubKeyHash, error) {
	pkHash := dogutil.Hash160(k.pubKeyBytes())
	return dogutil.NewAddressPubKeyHash(pkHash, net)
}
