...
// Tx returns a wrapped transaction (dogutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (dogutil.Tx) for all
...
// instead provides easy access to wrapped versions (dogutil.Tx) of them.
